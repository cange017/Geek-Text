...
1/24 Miguel created models/schemas for Comments, User, Author, and Book
1/25 Miguel re-migrate Book model to change comments from manyToMany to Foreing relationship
     overrode __str__() on Comments to display field on Admin
